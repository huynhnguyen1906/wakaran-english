...
export default function Footer() {
    return (
        <footer className='text-bg-color w-full pt-[24px] pb-[48px] md:pt-[64px] md:pb-[64px]'>
            <div className='w-full px-[24px] md:px-4'>
                ...
                <div className='block md:hidden'>
                    ...
                    <div className='mb-[24px] text-left'>
                        <p className='most-white mb-[8px] text-[16px]'>Education Website for English Leaners</p>
                        <h1 className='most-white text-[24px] font-bold tracking-wider'>WAKARAN ENGLISH</h1>
                    </div>
