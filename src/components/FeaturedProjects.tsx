    ...
    return (
        ...
        >
            ...
            <div className='relative mb-10 w-full overflow-hidden'>
                <div
                    className={`pointer-events-none absolute top-0 left-0 z-10 hidden h-full w-24 bg-gradient-to-r from-[#edece8]/100 to-transparent transition-opacity duration-300 md:block ${canScrollLeft ? 'opacity-100' : 'opacity-0'}`}
                />
                ...
                >
                    {projects.length === 0 ?
                        Array.from({ length: 4 }).map((_, i) => (
                            <div
                                key={`skeleton-${i}`}
                                className='h-[478px] w-[413px] shrink-0'
                            >
                ...
                <div
                    className={`pointer-events-none absolute top-0 right-0 z-10 hidden h-full w-24 bg-gradient-to-l from-[#edece8]/100 to-transparent transition-opacity duration-300 md:block ${canScrollRight ? 'opacity-100' : 'opacity-0'}`}
                />
            </div>
